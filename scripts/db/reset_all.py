...
def reset_all(data_dir: str = "data", skip_confirm: bool = False):
    ...
    print("  • Coder (llama3.2) - Full stack engineer")
    print("  • Designer (llama3.2) - UI/UX designer")
    print("  • Product Manager (llama3.2) - PM")
    print("  • Tester (llama3.2) - QA engineer")
    print()
    print("All agents have these tools enabled:")
    print("  • write_file, read_file, list_directory, web_search")
    print()
